...
export default function EditProfile(props) {
  const { userTL, overrides, ...rest } = props;
  const [
    ...
    await client.graphql({
      ...
      variables: {
        input: {
          ...
          bio: textFieldTwoNineSevenSixSixNineTwoTwoValue,
