        ...
        >
          ...
          >
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="David Moore"
              {...getOverrideProps(overrides, "David Moore")}
            ></Text>
          </Flex>
          <Flex
            gap="0"
          ...
          >
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="last seen 5 mins ago"
              {...getOverrideProps(overrides, "last seen 5 mins ago")}
            ></Text>
          </Flex>
        </Flex>
      </Flex>
      ...
      >
        ...
        >
          <Icon
            ...
            left="10.42%"
            right="12.51%"
            {...getOverrideProps(overrides, "Vector15167")}
          ></Icon>
        </View>
      </View>
      <View
      ...
      >
        ...
        >
          <Icon
            ...
            left="22.54%"
            right="19.13%"
            {...getOverrideProps(overrides, "Vector15170")}
          ></Icon>
        </View>
      </View>
      <View
      ...
      >
        ...
        >
          <Icon
            ...
            left="41.67%"
            right="41.67%"
            {...getOverrideProps(overrides, "Vector15173")}
          ></Icon>
        </View>
      </View>
    </Flex>
